...
class NotificationB(context: Context, workerParams: WorkerParameters) :
    CoroutineWorker(context, workerParams) {
    private val TAG: String = "NotificationB"
    ...
    override suspend fun doWork(): Result {
        ...
        if(userCode != null && userApp.room.userDao().getNotification(userCode)!=null && !userApp.room.userDao().getNotification(userCode)){
            ...
            var builder = NotificationCompat.Builder(context, channelId)
                ...
                .setContentText("Plantas regadas durante la tarde: $plantsIrrigatedB")
            ...
            Log.d("Prueba", "Notificacion B enviada")
